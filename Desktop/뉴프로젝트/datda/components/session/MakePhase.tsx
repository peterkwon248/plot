  ...
  return (
    <div className="flex flex-col items-center w-full min-h-[80vh] justify-center -mt-8">
      ...
      <motion.p
        ...
        className="text-xs tracking-[0.15em] text-[#807898] mb-12 text-center max-w-[260px] leading-relaxed"
      >
        {taskTitle}
      </motion.p>
      ...
      >
        <button
          onClick={goToClose}
          className="text-sm text-[#807898] hover:text-[#a78bfa] transition-colors duration-700 cursor-pointer"
        >
          닫으러 가기
        </button>
      </motion.div>
