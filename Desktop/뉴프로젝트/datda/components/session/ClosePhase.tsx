...
export default function ClosePhase() {
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center gap-3 text-center mb-8">
          ...
          <p className="text-xs text-[#706884] tracking-wider">{taskTitle}</p>
        </div>

        <div className="w-full flex flex-col gap-2 mb-8">
          <label className="text-sm text-[#a098b4]">
            결과를 어디에 남겼나요?
          </label>
          <input
            type="text"
          ...
          />
          <p className="text-xs text-[#706884]/50 tracking-wider">비워둬도 됩니다</p>
        </div>
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="text-xs text-[#706884] tracking-wider mt-2">{taskTitle}</p>
        </div>
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <button
            ...
            className="text-xs text-[#706884] hover:text-[#a098b4] cursor-pointer mt-4 transition-colors duration-300"
          >
            돌아가기
          </button>
        </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center mb-12">
        <p className="text-xs tracking-[0.3em] text-[#706884] uppercase mb-4">닫는 방법</p>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <p className="text-xs text-[#706884]">
                  {config.description}
                </p>
              </div>
            </motion.button>
