  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full max-w-md mx-auto">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-sm text-[#aea6c0]">
          시작이 아니라 '제한'입니다.
        </p>
      </div>
      ...
      <input
        ...
        className="w-full px-5 py-4 text-lg text-center bg-[#252530] border border-[#2d2d38] rounded-xl text-[#e8e8f0] placeholder:text-[#aea6c0]/50 focus:border-[#a78bfa] transition-colors duration-300"
        onKeyDown={(e) => {
          ...
          <button
            ...
            className={[
              ...
              selectedResult === type
                ...
                : "border-[#2d2d38] text-[#aea6c0] hover:border-[#807898]",
            ].join(" ")}
          >
            {type}
          </button>
      ...
      <div className="flex flex-col items-center gap-3">
        <span className="text-xs text-[#aea6c0] tracking-wide">
          세션 시간
        </span>
        <div className="flex items-center gap-2 flex-wrap justify-center">
            ...
            <button
              ...
              className={[
                ...
                selectedTimer === minutes
                  ...
                  : "bg-[#252530] border border-[#2d2d38] text-[#aea6c0] hover:border-[#807898]",
              ].join(" ")}
            >
              {minutes}분
            </button>
