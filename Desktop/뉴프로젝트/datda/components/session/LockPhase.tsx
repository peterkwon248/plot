...
export default function LockPhase() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full max-w-md mx-auto">
      ...
      {/* Completed Task */}
      <p className="text-[#aea6c0] text-center">{taskTitle}</p>

      {/* Location Input */}
      <div className="w-full flex flex-col gap-2">
        <label className="text-xs text-[#aea6c0]">
          결과를 어디에 남겼나요?
        </label>
        <input
          type="text"
          ...
          className="w-full px-4 py-3 bg-[#252530] border border-[#2d2d38] rounded-xl text-[#e8e8f0] placeholder:text-[#aea6c0]/50 focus:border-[#a78bfa] transition-colors duration-300"
          onKeyDown={(e) => {
